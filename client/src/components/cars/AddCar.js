...
class AddCar extends Component {
    ...
    onSubmit(e) {
        ...
        this.props.postCar(newCar, this.props.history);
            ...
            content = (
                <div className="row">
                    <div className="col-md-6 m-auto">
                        <h3 className="text-center mb-3">Add car</h3>
                        <form onSubmit={this.onSubmit} noValidate>
                            ...
                            <div className="form-group">
                                <input value={kilowatts} onChange={this.onChange} type="number" className={classnames('form-control form-control-lg mb-1', { 'is-invalid': errors.kilowatts })} name="kilowatts" id="kilowatts" placeholder="Kilowatts (kilowatts)" />
                            ...
                            <button onSubmit={this.onSubmit} className="btn btn-primary btn-block mt-4 mb-4">Add car</button>
                        </form>
                    </div>
                </div>
            )
